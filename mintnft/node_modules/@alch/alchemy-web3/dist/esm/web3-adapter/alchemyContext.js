...
export function makeAlchemyContext(url, config) {
    ...
    if (/^https?:\/\//.test(url)) {
        ...
        var _a = makePayloadSender(alchemySend, config, makePayload), sendPayload = _a.sendPayload, setWriteProvider = _a.setWriteProvider;
        ...
        var _b = makePayloadSender(alchemySend, config, makePayload), sendPayload = _b.sendPayload, setWriteProvider = _b.setWriteProvider;
        var senders = makeSenders(sendPayload, makePayload);
