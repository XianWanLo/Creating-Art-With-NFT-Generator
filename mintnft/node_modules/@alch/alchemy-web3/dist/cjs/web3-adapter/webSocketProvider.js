            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        promises_1.throwIfCancelled(isCancelled);
                        events = subscriptionBackfill_1.dedupeNewHeads(tslib_1.__spread(backfillEvents, backfillBuffer));
                    ...
                    case 6:
                        backfillEvents = _b.sent();
                        promises_1.throwIfCancelled(isCancelled);
                        events = subscriptionBackfill_1.dedupeLogs(tslib_1.__spread(backfillEvents, backfillBuffer));
